...
<div class="main-page-container">
    ...
    <a href="product.jsp">
        <button type="submit" class="btn btn-outline-dark btn-orders <%= "1".equals(categoryId) ? "active" : "" %>">
...
<div class="main-page-container-right">
    <h1 class="bg-dark text-white pd-5" style="width: 500px; border-radius: 10px">Add category</h1>
    <table class="table">
        <tbody>
        <tr>
            <th scope="row">
                <form action="/category/add" method="post">
                    <input class="form-control" name="name" type="text" placeholder="Enter categoryName: ">
                    <button class="btn btn-success my-2" style="float: right; font-weight: bold">Save</button>
                </form>
            </th>
        </tr>
        </tbody>
